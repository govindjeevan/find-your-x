...
class SpeakersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create speaker" do
    assert_difference('Speaker.count') do
      post speakers_url, params: { speaker: { desc: @speaker.desc, name: @speaker.name, title: @speaker.title } }
    end
  ...
  test "should update speaker" do
    patch speaker_url(@speaker), params: { speaker: { desc: @speaker.desc, name: @speaker.name, title: @speaker.title } }
